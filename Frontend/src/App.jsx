...
const Learn = lazy(() => import("./pages/website/Learn"));
const Community = lazy(() => import("./pages/Community"));
const Alerts = lazy(() => import("./pages/website/Alerts"));
...
const CheckColonyStatus = lazy(() =>
  import("./pages/dealer/CheckColonyStatus")
);
const AreaApprovalMap = lazy(() =>
  import("./pages/dealer/AreaApprovalMap")
);
const FraudReportStatus = lazy(() =>
  import("./pages/dealer/FraudReportStatus")
);
